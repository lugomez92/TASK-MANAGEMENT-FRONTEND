...
const AddTaskModal = ({ isOpen, closeModal, teamId, token, onTaskCreated, setMessage, fetchTasks }) => {
  ...
  useEffect(() => {
    ...
    axios.get(`${process.env.REACT_APP_API_URL}/api/teams/${teamId}/engineers`, {
